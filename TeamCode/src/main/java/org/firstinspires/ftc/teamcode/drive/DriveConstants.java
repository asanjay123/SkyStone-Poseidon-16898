...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 5.74; //width between wheels
     ...
     * empirically tuned.
     */
    public static double kV = .03244;
    public static double kA = 0.00357;
    public static double kStatic = .08977;
