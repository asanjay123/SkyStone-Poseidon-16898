...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 5.51; //width between wheels
     ...
     * empirically tuned.
     */
    public static double kV = 0.03400;
    public static double kA = 0.00371;
    public static double kStatic = .10691;
